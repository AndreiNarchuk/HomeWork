...
//        data.add(choice);
        ...
        System.out.println(data.add(6)+ ", ");
        System.out.println(data.add(56)+ ", ");
        System.out.println(data.add(333)+ ", ");
        System.out.println(data.add(65885)+ ", ");
        System.out.println(data.add(68)+ ", ");
        System.out.println(data.add(666335));
        ...
        data.sort(data);
        System.out.println("\n"+"Массив поле сортировки: " +data.toString());
         //10. Выводим содержание массива без null
        data.add(null);
        System.out.println("\n"+"Массив поле добавления null " +data.toString());
